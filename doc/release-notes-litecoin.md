...
A number of changes to the way Sustoken Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 glizzys per kB (0.00001 SUSSY). This is to prepare for dropping the minimum transaction fee to 0.1 glizzys per kB (0.0001 SUSSY) in the next release.
