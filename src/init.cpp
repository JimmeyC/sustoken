...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/sustoken-project/sustoken>";
    const std::string URL_WEBSITE = "<https://sustoken.org>";
