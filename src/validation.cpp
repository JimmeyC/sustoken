...
#if defined(NDEBUG)
# error "Sustoken cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Sustoken Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s SUSSY additional fees, %d delta bytes\n",
