...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s sustoken-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  sustoken-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sustoken transaction") + "\n" +
              "  sustoken-tx [options] -create [commands]   " + _("Create hex-encoded sustoken transaction") + "\n" +
              "\n";
