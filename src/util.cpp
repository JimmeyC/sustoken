...
const char * const BITCOIN_CONF_FILENAME = "sustoken.conf";
const char * const BITCOIN_PID_FILENAME = "sustoken.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Sustoken";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Sustoken";
#else
    // Unix
    return pathRet / ".sustoken";
#endif
#endif
}
