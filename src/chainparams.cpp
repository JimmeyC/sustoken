...
{
    const char* pszTimestamp = "The Age 12/03/2022 A new stage of terror: Zelensky accuses Russia of kidnapping mayor like ISIS terrorists";
...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.sustoken.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.sustokentools.com", true);
        vSeeds.emplace_back("dnsseed.sustokenpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.sustokentools.com", true);
        vSeeds.emplace_back("seed-b.sustoken.loshan.co.uk", true);
