...
Sustoken Core is released under the terms of the MIT license. See [COPYING](COPYING) for more
...
The developer [mailing list](https://groups.google.com/forum/#!forum/sustoken-dev)
should be used to discuss complicated or controversial changes before working
on a patch set.

Developer IRC can be found on Freenode at #sustoken-dev.
...
Translations are converted to Sustoken periodically.
